...
import com.example.ready2eat.View.LogIn;
import com.example.ready2eat.ViewHolder.Admin.AdminMenuViewHolder;
...
public class AdminHome extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if(id == R.id.nav_menu) {
            ...
            Paper.book().destroy();
            Intent signIn = new Intent(AdminHome.this, LogIn.class);
